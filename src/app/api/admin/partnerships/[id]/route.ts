...
export const PATCH = withApiObservability("admin.partnerships.patch", patchHandler);

export const DELETE = withApiObservability("admin.partnerships.delete", deleteHandler);
