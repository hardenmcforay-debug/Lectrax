  ...
  return (
    ...
    <section className="bg-white py-20 sm:py-24">
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <LandingReveal className="px-1 text-center sm:px-0">
        ...
        <LandingStagger className="mt-8 divide-y divide-border sm:mt-10 lg:mt-12">
          {faqs.map((faq) => (
            <LandingStaggerItem key={faq.q}>
              <details className="group">
                <summary className="flex cursor-pointer list-none items-start justify-between gap-3 py-3.5 text-left text-sm font-medium leading-snug text-slate-900 transition-colors hover:text-primary sm:gap-4 sm:py-4 sm:text-base [&::-webkit-details-marker]:hidden">
                ...
                <p className="pb-3.5 text-pretty text-xs leading-relaxed text-muted-foreground sm:pb-4 sm:text-sm md:text-base">
                  {faq.a}
                </p>
              </details>
            </LandingStaggerItem>
