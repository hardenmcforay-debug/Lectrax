      ...
      <section className="border-y border-slate-200/80 bg-white py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto mt-10 max-w-3xl rounded-2xl border border-slate-200 bg-slate-50/50 p-6 sm:p-8">
            ...
            <Link
              href="/partnerships"
              className="mt-8 inline-flex h-11 items-center justify-center rounded-xl bg-primary px-7 text-sm font-semibold text-white transition-colors hover:bg-primary/90"
            >
              Request Partnership
            </Link>
          </div>
