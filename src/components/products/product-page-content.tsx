    ...
    <MarketingPageEnter className="bg-gradient-to-b from-slate-50 via-white to-slate-50">
      <section className="border-b border-slate-200/80 bg-white py-14 sm:py-16 lg:py-20">
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:gap-14 lg:px-8">
          ...
          <HeroItem standalone delay={0.28}>
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <LandingStaggerList className="mx-auto mt-10 grid max-w-4xl gap-4 sm:grid-cols-2">
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <LandingStaggerList className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-2">
            {product.howItWorks.map((step, index) => {
              ...
              return (
                ...
                >
                  {howIllustration ? (
                    <ProductMediaMotion delay={0} float={false} className="mb-5">
                      {howIllustration}
                    </ProductMediaMotion>
                  ) : null}
      ...
      {product.guides && product.guides.length > 0 ? (
        <section className="border-y border-slate-200/80 bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <LandingStagger className="mx-auto mt-12 grid max-w-5xl gap-8 lg:grid-cols-2">
      ...
      {product.keyFacts && product.keyFacts.length > 0 ? (
        <section className="py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <LandingStaggerList className="mx-auto mt-10 grid max-w-4xl gap-3 sm:grid-cols-2">
      ...
      {product.faqs && product.faqs.length > 0 ? (
        <section className="border-y border-slate-200/80 bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <LandingStagger className="mx-auto mt-10 max-w-3xl space-y-4">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <LandingStagger className="mx-auto mt-10 grid max-w-4xl gap-4 sm:grid-cols-3">
            {product.outcomes.map((outcome, index) => (
              ...
              >
                <ProductMediaMotion delay={0} float={false} className="mb-4 w-full max-w-[10rem]">
                  <ProductOutcomeIllustration
      ...
      <section className="border-t border-slate-200/80 bg-white py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <LandingStagger className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {otherProducts.map((item) => {
              const Icon = PRODUCT_ICONS[item.slug];
              return (
                <LandingStaggerItem key={item.slug}>
                  <Link
                    href={`/products/${item.slug}`}
                    className="group block rounded-2xl border border-slate-200 bg-slate-50/50 p-5 transition-colors hover:border-primary/30 hover:bg-white hover:shadow-sm"
                  >
                    <Icon
