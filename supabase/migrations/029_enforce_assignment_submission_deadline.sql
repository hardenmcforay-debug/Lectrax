-- Enforce assignment submission deadlines at database level (RLS, storage, and triggers).
...
-- Remove legacy policy that allowed submissions without a deadline check.
...
-- Block storage uploads after the assignment deadline.
