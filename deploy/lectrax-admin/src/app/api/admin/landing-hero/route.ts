...
export const POST = withApiObservability("admin.landing-hero.post", postHandler);

export const DELETE = withApiObservability("admin.landing-hero.delete", deleteHandler);
